...
import com.askerlve.ascache.Ascache;
...
public class AsCache107<K, V> implements Cache<K, V> {

	private Ascache<K, V> csCache = new Ascache<>(new BasicDataStore<K, V>());
	private volatile boolean isClosed;

	private String cacheName;

	private AsCache107Manager cacheManager;

	private Configuration<K, V> configuration;

	public AsCache107(AsCache107Manager cacheManager, String cacheName, Configuration<K, V> configuration) {
